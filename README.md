...
> ⚠️ **Notice:** 본 버전은 여러 테스트와 안정성 검증을 진행하는 과정에서 공개하는 데모(Demo) 빌드입니다. 현재 1GB 크기의 LM 스튜디오 데이터를 기준으로 테스트 시 7z 대비 약 200MB 정도 압축률이 뒤처져 있으나, 안정성을 확보하고 향후 7z 이상의 성능을 달성하는 것을 목표로 지속 개선 중입니다. 다양한 환경에서의 테스트와 피드백을 부탁드립니다.
